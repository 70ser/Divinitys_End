...
execute unless score @s XPcost > $repair_max XPcost unless score @s LapisCost > $repair_max LapisCost run summon sheep ~2 ~ ~ {DeathTime:19,UUID:[I;823664661,407986577,402,322246937],Sheared:1b,NoGravity:1b,Silent:1b,CustomNameVisible:1b,DeathLootTable:"no",NoAI:1b,Health:1000f,Size:0,Tags:["repair_interact_confirm"],CustomName:'[{"text":"[","color":"white"},{"keybind":"key.attack","color":"aqua"},{"text":"] to repair!"}]',Attributes:[{Name:generic.max_health,Base:1000}]}
