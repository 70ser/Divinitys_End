...
scoreboard objectives add de_pear_var dummy
scoreboard players set #1140 de_pear_var 1140
scoreboard players set #260 de_pear_var 260
scoreboard players set #20 de_pear_var 20
scoreboard players set #3 de_pear_var 3
scoreboard players set #2 de_pear_var 2
