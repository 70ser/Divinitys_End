tag @s add placed
particle dust 0.886 0.329 0.231 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 0.900 0.329 0.231 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 0.886 0.329 0.231 1 ~ ~.9 ~ .7 .2 .7 0 100 force
...
playsound minecraft:music_disc.blocks master @a ~ ~ ~ 1 1.4 1
