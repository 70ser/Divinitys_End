...
particle dust 0.800 0.800 0.800 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 1.000 1.000 1.000 1 ~ ~.9 ~ .7 .2 .7 0 100 force
...
playsound minecraft:music_disc.strad master @a ~ ~ ~ 1 1.4 1
