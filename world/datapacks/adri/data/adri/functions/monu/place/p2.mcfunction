tag @s add placed
particle dust 0.298 1.000 0.000 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 0.122 0.408 0.000 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 0.298 1.000 0.000 1 ~ ~.9 ~ .7 .2 .7 0 100 force
...
playsound minecraft:music_disc.cat master @a ~ ~ ~ 1 1.4 1
