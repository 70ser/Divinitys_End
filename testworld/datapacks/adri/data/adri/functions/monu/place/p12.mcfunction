tag @s add placed
particle dust 0.506 0.663 0.886 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 0.282 0.455 0.702 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 0.506 0.663 0.886 1 ~ ~.9 ~ .7 .2 .7 0 100 force
...
playsound minecraft:music_disc.wait master @a ~ ~ ~ 1 1.4 1
