tag @s add placed
particle dust 0.000 1.000 0.565 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 0.714 1.000 0.000 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 0.000 1.000 0.565 1 ~ ~.9 ~ .7 .2 .7 0 100 force
...
playsound minecraft:music_disc.far master @a ~ ~ ~ 1 1.4 1
