...
execute as @e[type=arrow,limit=1,sort=nearest,scores={helper_lifetime=1}] run data merge entity @s {Color:15597823,CustomPotionEffects:[{Id:9,Amplifier:30b,Duration:100}],Potion:"minecraft:awkward"}
