tag @s add placed
particle dust 1.000 0.000 0.016 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 0.498 0.000 0.008 1 ~ ~5 ~ .1 10 .1 0 300 force
particle dust 1.000 0.000 0.016 1 ~ ~.9 ~ .7 .2 .7 0 100 force
...
playsound minecraft:music_disc.chirp master @a ~ ~ ~ 1 1.4 1
